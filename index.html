    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="photo/c1.jpg" class="d-block w-100 img-fluid" alt="...">
            ...
            <div class="carousel-item">
                <img src="photo/c2.jpg" class="d-block w-100 img-fluid" alt="...">
                <div class="carousel-caption d-none d-md-block ">
                    <h2>Welcome to iCoder</h2>
                    <p>Technology News , Development and Trends</p>
                    <button class="btn btn-danger "> <a class="text-decoration-none text-light " href="newparcel.php">Add Parcel</a></button>
            ...
            <div class="carousel-item">
                <img src="photo/c3.jpg" class="d-block w-100 img-fluid" alt="...">
                <div class="carousel-caption d-none d-md-block ">
                    <h2>Welcome to iCoder</h2>
                    <p>Technology News , Development and Trends</p>
                    <button class="btn btn-danger "> <a class="text-decoration-none text-light " href="newparcel.php">Add Parcel</a></button>
        ...
        <div class="row mt-3">
            <div class=" col col-md-3">
                <div class="card mx-auto" style="width: 18rem;">
                    <img src="photo/s1.jpg" class="card-img-top img-fluid" alt="...">
            ...
            <div class="col col-md-3">
                <div class="card mx-auto" style="width: 18rem;">
                    <img src="photo/s2.jpg" class="card-img-top img-fluid" alt="...">
                    <div class="card-body text-center">
            ...
            <div class="col col-md-3">
                <div class="card mx-auto" style="width: 18rem;">
                    <img src="photo/s3.jpg" class="card-img-top img-fluid" alt="...">
                    <div class="card-body text-center">
            ...
            <div class="col col-md-3">
                <div class="card mx-auto" style="width: 18rem;">
                    <img src="photo/s4.webp" class="card-img-top img-fluid" alt="...">
                    <div class="card-body text-center">
